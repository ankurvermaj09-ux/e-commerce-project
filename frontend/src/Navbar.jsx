...
import { Home, Package, ShoppingCart, Heart, ClipboardList, User, LayoutDashboard, LogOut, LogIn, Info, LifeBuoy } from "lucide-react";
...
export default function Navbar({user,cartCount,onLogout,wishlistCount}){
    return(
        ...
        <nav>
            ...
            {user && (
            <Link to="/support"><LifeBuoy size={18}/></Link>
            )}
